...
const INITIAL_CNSS_DATA: CnssRow[] = [
  {
    id: 1,
    entreprise: "STE MAROC PIECES AUTO SARL",
    annee: "2025",
    mois: "Avril",
    type: "pdf",
    fichier: "bordereau_cnss_04.pdf",
    tiers: "CNSS",
    cat: "CNSS",
    ref: "BDS-0425",
    date: "10/05/2025",
    libelle: "Cotisations Avril 2025",
    ht: "12 450.00",
    tva: "0.00 (0%)",
    ttc: "12 450.00",
    statut: "Saisi",
  ...
  },
  {
    ...
    mois: "Mai",
    type: "pdf",
    fichier: "recu_paiement_cnss.pdf",
    tiers: "CNSS",
    cat: "CNSS",
    ref: "REC-9982",
    date: "12/05/2025",
    libelle: "Reçu paiement cotisations",
    ht: "12 450.00",
    tva: "0.00 (0%)",
    ttc: "12 450.00",
    statut: "Saisi",
...
export function CnssPage() {
  ...
  const [cnssData, setCnssData] =
    useState<CnssRow[]>(INITIAL_CNSS_DATA);
  ...
  const handleView = (fichier: string) => {
    alert(
      `Affichage de l'aperçu pour le fichier : ${fichier}`
    );
  };
  ...
  const handleExport = () => {
    ...
    link.setAttribute(
      "download",
      `Export_CNSS_${entreprise.replace(
        /\s/g,
        "_"
      )}_${mois}_${annee}.csv`
    );
      ...
      <div className="flex flex-wrap items-end justify-between gap-4 mb-6">
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="STE MAROC PIECES AUTO SARL">
                STE MAROC PIECES AUTO SARL
              </option>
            </select>
          </div>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="bg-white border border-slate-200 text-slate-700 px-4 py-2 rounded-md text-sm font-semibold flex items-center gap-2 hover:bg-slate-50 transition-colors shadow-sm"
          >
            Exporter vers Excel
            ...
            <table className="w-full text-sm text-left whitespace-nowrap">
              ...
              <thead className="bg-slate-50 text-slate-500 font-semibold border-b border-slate-200">
                ...
                <tr>
                  ...
                  <th className="px-4 py-3 text-xs text-right">
                    Montant HT ▽
                  </th>
                ...
                {donneesFiltrees.length === 0 ? (
                  ...
                  donneesFiltrees.map((row) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-xs font-semibold text-slate-700 w-32 truncate whitespace-normal leading-tight">
                        {row.entreprise}
                      </td>
                      ...
                      <td className="px-4 py-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleView(row.fichier)
                            }
                            className="text-fuchsia-600 font-medium text-xs hover:underline cursor-pointer"
                          >
                            {row.fichier}
                          </button>
                      ...
                      <td className="px-4 py-3 text-xs font-bold whitespace-normal leading-tight w-32">
                        {row.tiers}
                      </td>
                      ...
                      <td className="px-4 py-3 text-xs text-slate-500 w-48 truncate">
                        {row.libelle}
                      </td>
          ...
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-5">
            ...
            <div className="space-y-2">
              ...
              <div
                ...
                className="flex items-center gap-3 p-2 hover:bg-slate-50 border border-transparent rounded-lg cursor-pointer transition-colors group"
              >

                <div className="w-9 h-9 bg-blue-50 group-hover:bg-blue-100 group-hover:text-blue-700 text-blue-600 rounded-md flex items-center justify-center text-lg transition-colors">
                  🛒
                </div>
                ...
                <div>
                  ...
                  <div className="text-[11px] font-medium text-slate-500 group-hover:text-blue-600 transition-colors">
                    Documents d'achat
                  </div>
                </div>
              ...
              >
                ...
                <div className="w-9 h-9 bg-green-50 group-hover:bg-green-100 group-hover:text-green-700 text-green-600 rounded-md flex items-center justify-center text-lg transition-colors">
                  🛍
                </div>

                <div>
                  <div className="text-sm font-semibold text-slate-700 group-hover:text-green-700 transition-colors">
                    Ventes
                  </div>

                  <div className="text-[11px] font-medium text-slate-500 group-hover:text-green-600 transition-colors">
                    Documents de vente
                  </div>
                </div>
              ...
              >
                ...
                <div className="w-9 h-9 bg-indigo-50 group-hover:bg-indigo-100 group-hover:text-indigo-700 text-indigo-600 rounded-md flex items-center justify-center text-lg transition-colors">
                  🏦
                </div>
                ...
                <div>
                  ...
                  <div className="text-[11px] font-medium text-slate-500 group-hover:text-indigo-600 transition-colors">
              ...
              <div className="flex items-center gap-3 p-2 bg-fuchsia-50/70 border border-fuchsia-100 rounded-lg cursor-default">
                ...
                <div className="w-9 h-9 bg-white shadow-sm border border-fuchsia-100 text-fuchsia-600 rounded-md flex items-center justify-center text-lg">
                  📄
                </div>
                ...
                <div>
                  ...
                  <div className="text-[11px] font-medium text-fuchsia-500">
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 animate-fade-in-up">
            ...
            <div className="flex justify-between items-center mb-5 border-b border-gray-100 pb-3">
              ...
              <button
                ...
                className="text-slate-400 hover:text-red-500 text-2xl font-bold transition-colors leading-none"
              >
                &times;
              </button>
