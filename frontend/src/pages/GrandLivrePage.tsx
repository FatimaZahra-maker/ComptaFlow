...
export function GrandLivrePage() {
  ...
  }, [entrepriseId, dateDebut, dateFin, comptePrefix]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-5 lg:p-8">
      <div className="mx-auto max-w-[1500px]">
        <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Mouvements validés, compte par compte, toujours en MAD.
            </p>
          </div>
          <button
            type="button"
        ...
        {entreprises.length === 0 && <p className="mb-5 rounded-lg border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800">Aucune entreprise ne possÃ¨de encore de donnÃ©es dans ce module.</p>}
