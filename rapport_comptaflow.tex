...
L'interface du plan comptable permet de sélectionner le dossier d'entreprise,
de rechercher les comptes actifs et d'ajouter les comptes exacts selon leur
usage : HT, TVA, fournisseur, client, banque ou différence de change. Lorsqu'une
pré-écriture ne peut pas être validée faute d'imputation, l'écran de contrôle
oriente ainsi l'utilisateur vers ce paramétrage sans inventer de numéro de compte.

\capture{captures/plan_comptable.png}{Gestion du plan comptable propre à l'entreprise}{fig:plan-comptable-interface}
